...
def test_claude_command_uses_anthropic_base_url_and_no_proxy():
    module = _load_module("claude_code_runner_test", "examples/claude_code/claude_code_runner.py")
...
def test_rewrite_gateway_url_removes_v1_for_anthropic_sdk_base():
    module = _load_module("claude_sandbox_test", "examples/claude_code/sandbox.py")
