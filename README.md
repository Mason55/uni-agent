...
Uni-Agent is a unified framework for building, running, and training agents at scale. It brings agent interaction, tool use, and RL training into one stack, making it easy to move from lightweight prototyping to large-scale execution.

The long-term vision of Uni-Agent is to build the backend infrastructure for next-generation agents that can perceive, act, and explore open-ended worlds.
...
| Model | Benchmark | OpenHands | Uni-Agent |
|-------|:---------:|:---------:|:-----------:|
| Qwen3-Coder-480B | SWE-Bench-Verified | 62.4 |           |
| Qwen3-Coder-Next | SWE-Bench-Verified | 66.6 |           |
...
- [ ] More training engines, such as slime.
- [ ] Flexible integration with RL backends.
